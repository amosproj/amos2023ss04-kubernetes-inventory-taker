    ...
    return (
        <div className="flex row">
            ...
            <div className="pr-4">
                ...
                <div>
                        <a href="#" className="block max-w-xs p-12 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                            <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">CPU Usage</h5>
            ...
            <div className="pl-4">
                ...
                <div>
                        <a href="#" className="block max-w-xs p-12 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                            <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Memory Usage</h5>
            ...
            <section>
                <header>
                    ...
                    <div className="">
                            <Table>
                                <Table.Head>
                                    <Table.HeadCell className="!py-2 bg-gray-50 dark:bg-gray-800">Status</Table.HeadCell>
                                    <Table.HeadCell className="!py-2 bg-gray-30 dark:bg-gray-600">Name</Table.HeadCell>
                                    <Table.HeadCell className="!py-2 bg-gray-30 dark:bg-gray-600">Port</Table.HeadCell>
                                    <Table.HeadCell className="!py-2 bg-gray-30 dark:bg-gray-600">Started</Table.HeadCell>
                                </Table.Head>
